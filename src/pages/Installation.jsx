            ...
            <SEO
                ...
                schema={{
                    ...
                    "@graph": [
                        {
                            "@type": "WebPage",
                            "name": "How to Install FRP Manhole Covers | BS EN 124 Technical Guide",
                            "description": "Technical step-by-step guide for proper seating and concrete embedding of composite FRP and GRP manhole covers to ensure BS EN 124 load test capacity.",
                            "url": "https://www.flortekfrpcover.com/installation",
                            "breadcrumb": {
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">
                            Installation & <br /> <span className="text-[#FFC700]">Technical Data</span>
                        </h1>
                ...
                <div className="max-w-5xl mx-auto px-4 space-y-16">
                    ...
                    <div className="bg-[#F5F5F5] rounded-[3rem] p-8 md:p-12 border border-[#D9D9D9]">
                        <div className="flex items-center gap-4 mb-8">
                            <div className="w-12 h-12 rounded-2xl bg-[#1B8036]/10 border border-[#1B8036]/20 flex items-center justify-center text-[#1B8036] shadow-sm">
                                <ShieldCheck size={28} />
                            </div>
                            <h2 className="text-2xl md:text-3xl font-black text-black uppercase tracking-tight">Load Testing Standards</h2>
                        </div>

                        <div className="prose prose-slate max-w-none text-black font-medium leading-relaxed space-y-6">
                            <p>
                            ...
                            <div className="bg-white p-6 rounded-2xl border-l-4 border-[#1B8036] my-6 shadow-sm">
                                <p className="mb-4">
                    ...
                    <div className="bg-[#F5F5F5] rounded-[3rem] p-8 md:p-12 border border-[#D9D9D9] relative overflow-hidden">
                        <div className="flex items-center gap-4 mb-10 relative z-10">
                            ...
                            <h2 className="text-2xl md:text-3xl font-black text-black uppercase tracking-tight">Installation Procedure</h2>
                        </div>

                        <div className="grid md:grid-cols-2 gap-12 relative z-10 mb-12">
                            <ul className="space-y-6 text-black font-medium leading-relaxed list-none">
                                <li className="flex gap-4">
                                    <span className="shrink-0 w-8 h-8 rounded-full bg-[#1B8036] text-white flex items-center justify-center font-black text-sm">1</span>
                                    <span>
                                ...
                                <li className="flex gap-4">
                                    <span className="shrink-0 w-8 h-8 rounded-full bg-[#1B8036] text-white flex items-center justify-center font-black text-sm">2</span>
                                    <span>
                                        Prepare concrete bed considering height of the frame.
                                    </span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="shrink-0 w-8 h-8 rounded-full bg-[#1B8036] text-white flex items-center justify-center font-black text-sm">3</span>
                                    <span>
                                        Frame should be embedded in minimum <strong>M-20 grade concrete</strong>.
                                    </span>
                                </li>
                                <li className="flex gap-4">
                                    <span className="shrink-0 w-8 h-8 rounded-full bg-[#1B8036] text-white flex items-center justify-center font-black text-sm">4</span>
                                    <span>
                                ...
                                <li className="flex gap-4">
                                    <span className="shrink-0 w-8 h-8 rounded-full bg-[#FFC700] text-[#0B1B3D] flex items-center justify-center font-black text-sm">!</span>
                                    <span>
                            ...
                            <div className="bg-white p-6 rounded-3xl border border-[#D9D9D9]/50 flex flex-col justify-center text-center shadow-sm">
                                <AlertTriangle className="mx-auto text-[#FFC700] mb-4 fill-[#FFC700]/20" size={40} />
                                <h4 className="font-black text-black mb-2 uppercase tracking-tight">Critical Warning</h4>
                        ...
                        <div className="mt-12 relative z-10 border-t border-[#D9D9D9]/50 pt-10">
                            <h3 className="font-black text-black mb-8 flex items-center gap-2 uppercase tracking-tight">
                                <span className="w-2.5 h-2.5 rounded-full bg-[#1B8036]"></span> Technical Diagrams
                            </h3>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="bg-white rounded-2xl p-4 border border-[#D9D9D9]/50 shadow-sm">
                                    ...
                                    />
                                    <p className="text-center text-xs font-black text-black mt-4 uppercase tracking-widest">
